...
namespace
{
	const char* START_SCRIPTTXT = "SCRIPT";					// スクリプト開始確認文字
	const char* END_SCRIPTTXT = "END_SCRIPT";				// スクリプト終了確認文字
	const char* TEXTURENUM_TXT = "NUM_TEXTURE";				// テクスチャ使用枚数確認文字
	...
	const char* MODELSET_TXT = "MODELSET";					// モデル配置確認文字
	const char* ENDMODELSET_TXT = "END_MODELSET";			// モデル読み込み終了
	const char* LOAD_POS = "POS";							// 座標
	const char* LOAD_ROT = "ROT";							// 向き
	const char* LOAD_TEXTYPE = "TEXTYPE";					// テクスチャ番号
	const char* LOAD_MODELTYPE = "TYPE";					// モデル番号
	const char* LOAD_BLOCK = "BLOCK";						// 枚数
	const char* LOAD_SIZE = "SIZE";							// サイズ
	const char* LOAD_SHADOW = "SHADOW";						// 影
	const char* LOAD_UPDOWN = "UPDOWN";						// 起伏
	const char* LOAD_VTXMAX = "VTXMAX";						// 当たり判定最大
	const char* LOAD_VTXMIN = "VTXMIN";						// 当たり判定最小
}
