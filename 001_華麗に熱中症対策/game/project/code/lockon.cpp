...
namespace
{
	const float MULTIDEF_SIZE = (50.0f);		// デフォルトサイズ
	const float MULTISTART_SIZE = (1000.0f);	// 表示開始サイズ
	const float MULTIMINUS_SIZE = (120.0f);	// サイズ変更
	const float MULTIADD_COLA = (0.1f);	// 色
	const float DEF_SIZE = (35.0f);	// デフォルトサイズ
	const float START_SIZE = (300.0f);	// 表示開始サイズ
	const float MINUS_SIZE = (30.0f);		// サイズ変更
	const float ADD_COLA = (0.1f);	// 色
	const float SHOT_LENGTH = (3000.0f);
}
